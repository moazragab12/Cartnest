...
// =================================================================================
// === PRODUCT CARD CREATION LOGIC (INTERNAL IMPLEMENTATION DETAILS)            ===
// =================================================================================

/**
 * Main internal function to create a product card DOM element.
...
function _createProductImageWithFallback(parentElement, product) {
  ...
  _createAndAppendElement(productImageWrapper, {
    ...
    eventListeners: {
      error: function () {
        this.src = "./public/resources/images/products/smartwatch.jpg"; // Fallback image
